...
#
# wget -O /tmp/install-updatengine-client.sh https://raw.githubusercontent.com/noelmartinon/updatengine-client/nm-dev/LinuxDpkg/setup/install-updatengine-client.sh && chmod +x /tmp/install-updatengine-client.sh && sudo /tmp/install-updatengine-client.sh "https://UE-SERVER_IP:1979"
##
